...
// TABLES
// 翻译逻辑:    transsentence   filetrans
// 翻译工具:    trandir     dictinfo    dictiteminfo    templatelibinfo     templateiteminfo
//              afterdictinfo   afteriteminfo
// 业务逻辑:    usercharege
// 目测无用:    chsegment

// transsentence
sql_create_14(transsentence, 1, 14,
...
// templatelibinfo
sql_create_10(templatelibinfo, 1, 10,
...
// templateiteminfo
sql_create_7(templateiteminfo, 1, 7,
    mysqlpp::sql_int, tid,                  //词条id
...
// afterdictinfo
sql_create_9(afterdictinfo, 1, 9,
    mysqlpp::sql_int, tid,                  //dict id
    mysqlpp::sql_varchar, username,
    mysqlpp::sql_tinyblob, dictname,
    mysqlpp::sql_int, isdeleted,            //是否已删除  1表示已经删除
...
// afterdictiteminfo
sql_create_6(afterdictiteminfo, 1, 6,
    mysqlpp::sql_int, tid,              //词条id
